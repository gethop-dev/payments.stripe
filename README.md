...
This are the methods available to interact with the Stripe API. The mapping for the methods is one to one, so refer to the Stripe  official documentation for details.
  ...
  * [Coupons](https://docs.stripe.com/api/coupons)
    * [(create-coupon stripe-record coupon)](https://docs.stripe.com/api/coupons/create)
    * [(update-coupon stripe-record coupon-id coupon)](https://docs.stripe.com/api/coupons/update)
    * [(get-coupon stripe-record coupon-id)](https://docs.stripe.com/api/coupons/retrieve)
    * [(get-all-coupons stripe-record opt-args)](https://docs.stripe.com/api/coupons/list)
    * [(delete-coupon stripe-record coupon-id)](https://docs.stripe.com/api/coupons/delete)
  ...
  * [PaymentMethod](https://stripe.com/docs/api/payment_methods)
    * [(create-payment-method stripe-record payment-method)](https://docs.stripe.com/api/payment_methods/create)
    * [(update-payment-method stripe-record payment-method-id payment-method)](https://docs.stripe.com/api/payment_methods/update)
    * [(get-payment-method stripe-record payment-method-id)](https://stripe.com/docs/api/payment_methods/retrieve)
    * [(get-payment-methods stripe-record opt-args)](https://stripe.com/docs/api/payment_methods/retrieve)
    * [(get-customer-payment-method stripe-record customer-id payment-method-id)](https://docs.stripe.com/api/payment_methods/customer)
  ...
  * [PromotionCode](https://docs.stripe.com/api/promotion_codes)
    * [(create-promotion-code stripe-record promotion-code)](https://docs.stripe.com/api/promotion_codes/create)
    * [(update-promotion-code stripe-record promotion-code-id promotion-code)](https://docs.stripe.com/api/promotion_codes/update)
    * [(get-promotion-code stripe-record promotion-code-id)](https://docs.stripe.com/api/promotion_codes/retrieve)
    * [(get-all-promotion-codes stripe-record opt-args)](https://docs.stripe.com/api/promotion_codes/list)
  ...
  * [TaxRate](https://docs.stripe.com/api/tax_rates)
    * [(create-tax-rate stripe-record tax-rate)](https://docs.stripe.com/api/tax_rates/create)
    * [(update-tax-rate stripe-record tax-rate-id tax-rate)](https://docs.stripe.com/api/tax_rates/update)
    * [(get-tax-rate stripe-record tax-rate-id)](https://docs.stripe.com/api/tax_rates/retrieve)
    * [(get-all-tax-rates stripe-record opt-args)](https://docs.stripe.com/api/tax_rates/list)
